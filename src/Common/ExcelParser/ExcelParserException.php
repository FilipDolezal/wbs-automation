...
{
    public const CODE_CELL_NOT_FOUND = 100;
    public const CODE_UNEXPECTED_NULL = 101;
    public const CODE_UNEXPECTED_TYPE = 102;
    public const CODE_CALCULATION_ERROR = 103;
    public const CODE_DUPLICATE_ENTITY = 200;
    public const CODE_UNKNOWN_ERROR = 999;
